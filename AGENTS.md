...
Codex++ is a standalone Windows launcher for the Microsoft Store Codex app. It is not a Codex
plugin package.
...
`%LOCALAPPDATA%\Codex++\Codex++.exe`, skip self-copy and still refresh the shortcut.
