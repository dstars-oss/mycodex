...
MyCodex is an MVP launcher for the Microsoft Store Codex app on Windows. It starts the packaged
...
The shortcut launches `MyCodex.exe launch` and uses the Microsoft Store `app\Codex.exe` icon.
